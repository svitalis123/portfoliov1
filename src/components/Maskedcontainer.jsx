...
export function Maskedcontainer() {
  return (
    <div className="h-[40rem] w-full flex items-center justify-center  overflow-hidden">
      ...
      >
        I've embarked on numerous projects throughout the years, but these are the ones I hold closest to my <span className="text-red-500">Heart</span> . Many of them are open-source, so if you come across something that piques your interest, feel free to explore the codebase and contribute your ideas for further enhancements. <a href="/contact" className="text-red-500">Contact me!</a> 
      </MaskContainer>
    </div>
  );
}